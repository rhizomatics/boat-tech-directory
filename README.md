...
- [SignalK Community](https://signalk.org/community/) - Discord and GitHub Discussions.
...
- [OpenWaters](https://openwaters.io) - Open source nautical web map tiles: [Seamap](https://openwaters.io/charts/seamap), a chart style rendered weekly from OpenStreetMap seamarks, [AISCast](https://openwaters.io/ais/), [Sky Almanac](https://openwaters.io/sky/), [CrowdDepth](https://openwaters.io/bathymetry/crowd-depth/) and [Seascape](https://openwaters.io/charts/seascape), global bathymetry merged from GEBCO and regional open sources. Plus tide predictions.
...
- [Yacht Management Software (YMS)](https://yms.hoogi.de) - Open-source, self-hosted yacht management software for sailing boats, designed for Raspberry Pi/Linux and offline operation.
...
- [OpenSkipper](https://openskipper.org) - C# based NMEA2000, NMEA0183 and AIS integration, last updated 2023.
